...
# Custom UI Colors - using direct RGB values
UI_COLORS = {
    ...
    'dark_gray': color.rgb(40, 40, 40),      # Added dark gray
    'medium_gray': color.rgb(80, 80, 80),    # Added medium gray
    'light_gray': color.rgb(120, 120, 120),  # Added light gray
}
...
class ModernButton(Button):
    def __init__(self, text='', **kwargs):
        ...
        self.pressed_color = color.rgb(31, 118, 175)  # Darker blue
...
def input(key):
    ...
    # Weapon selection
    if key in ['1', '2', '3', '4', '5']:
        weapon_wheel.select_weapon(int(key) - 1)
